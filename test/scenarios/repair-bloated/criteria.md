...
- R7: Removes Notion, optional skill recommendations, `tm` commands, and
  worktree/task lifecycle instructions.
- R8: Does not invent tools, cloud providers, package managers, or issue
  workflows.
- R9: Is shorter and clearer than the original `AGENTS.md`.
