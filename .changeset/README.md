...
Use an empty changeset when repository-only maintenance touches a public
package directory but does not change its packed artifact. State why no package
release is needed. See
[`docs/release-management.md`](../docs/release-management.md) for the check.
