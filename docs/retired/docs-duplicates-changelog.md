# Docs Duplicate Checker Changelog

The retired npm package was
`@buresmi7/agent-doc-rules-docs-duplicates`. Its deterministic candidate
scanner moved into `@buresmi7/agent-doc-rules-docs-validator`, and its semantic
review workflow moved into the installed skills after version `0.12.0`.

## 0.12.0

### Minor Changes

- 716bdcb: Use a compatible explicit or `PATH` Codex CLI before an opt-in
  project-local fallback, without installing Codex as a package dependency.
