# Criteria: docs-validation-routing

Critical criteria:

- D1: Creates a concise root `AGENTS.md` for the fixture project.
- D2: Includes a short verification rule that uses the existing
  `npm run docs:check` command for documentation, README, `AGENTS.md`, skill,
  or template changes.
